...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets/creative-tim/img/apple-icon.png') }}">
    <link rel="icon" type="image/png" href="{{ asset('assets/creative-tim/img/favicon.png') }}">
    <title>
    ...
    <link href="{{ asset('assets/creative-tim/css/nucleo-svg.css') }}" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('assets/creative-tim/css/soft-ui-dashboard.css?v=1.0.7') }}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="" target="_blank">
                <img src="{{ asset('assets/shared/media/logos/default-sidebar-small.png') }}"
        ...
        <div class="sidenav-footer mx-3 ">
            <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                <div class="full-background"
                    style="background-image: url('{{ asset('assets/creative-tim/img/curved-images/white-curved.jpg') }}">
                </div>
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item d-flex align-items-center">
                            ...
                            <form id="logout-form" method="POST" action="{{ route('landlord.logout') }}">
                                @csrf
                                <a href="{{ route('landlord.logout') }}"
                                    onclick="event.preventDefault(); document.getElementById('logout-form').submit()"
                                    class="nav-link text-body font-weight-bold px-0">
                                    <i class="fa fa-user me-sm-1"></i>
                                    <span class="d-sm-inline d-none">@lang('auth.logout')</span>
                                </a>
                            </form>
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="{{ asset('assets/creative-tim/img/team-2.jpg') }}"
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="{{ asset('assets/creative-tim/img/small-logos/logo-spotify.svg') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                                    <div class="bg-gradient-primary border-radius-lg h-100">
                                        <img src="{{ asset('assets/creative-tim/img/shapes/waves-white.svg') }}"
                                            class="position-absolute h-100 w-50 top-0 d-lg-block d-none"
                                            alt="waves">
                                        <div
                                            class="position-relative d-flex align-items-center justify-content-center h-100">
                                            <img class="w-100 position-relative z-index-2 pt-4"
                                                src="{{ asset('assets/creative-tim/img/illustrations/rocket-white.png') }}"
                                                alt="rocket">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-5">
                    <div class="card h-100 p-3">
                        <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                            style="background-image: url('{{ asset('assets/creative-tim/img/ivancik.jpg') }}">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('assets/creative-tim/img/small-logos/logo-xd.svg') }}"
                                            ...
                                            <td>
                                                <div class="avatar-group mt-2">
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        ...
                                                        title="Ryan Tompson">
                                                        <img src="{{ asset('assets/creative-tim/img/team-1.jpg') }}"
                                                            alt="team1">
                                                    </a>
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    ...
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        ...
                                                        <img src="{{ asset('assets/creative-tim/img/team-3.jpg') }}"
                                                            alt="team3">
                                                    </a>
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Jessica Doe">
                                                        <img src="{{ asset('assets/creative-tim/img/team-4.jpg') }}"
                                                            alt="team4">
                                                    </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('assets/creative-tim/img/small-logos/logo-atlassian.svg') }}"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('assets/creative-tim/img/small-logos/logo-slack.svg') }}"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('assets/creative-tim/img/small-logos/logo-jira.svg') }}"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('assets/creative-tim/img/small-logos/logo-invision.svg') }}"
    ...
    <!--   Core JS Files   -->
    <script src="{{ asset('assets/creative-tim/js/core/popper.min.js') }}"></script>
    <script src="{{ asset('assets/creative-tim/js/core/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets/creative-tim/js/plugins/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('assets/creative-tim/js/plugins/smooth-scrollbar.min.js') }}"></script>
    <script src="{{ asset('assets/creative-tim/js/plugins/chartjs.min.js') }}"></script>
    <script>
    ...
    <script src="{{ asset('assets/creative-tim/js/soft-ui-dashboard.min.js?v=1.0.7') }}"></script>
</body>
