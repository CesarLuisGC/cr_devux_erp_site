            ...
            <div class="col-sm-6">
                ...
                <div class="d-flex flex-column h-100">
                        ...
                        <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                            ...
                            <div class="d-flex align-items-center me-5 me-xl-13">
                                ...
                                <div class="m-0">
                                    ...
                                    <a href="?page=pages/user-profile/overview" class="fw-bold text-gray-800 text-hover-primary fs-7">Robert Fox</a>
                                </div>
                                <!--end::Info-->
                            </div>
                            <!--end::Item-->
                    ...
                    <div class="d-flex flex-stack mt-auto bd-highlight">
                        ...
                        <!--end::Users group-->
                        <!--begin::Actions-->
                        <a href="?page=apps/projects/project" class="d-flex align-items-center text-primary opacity-75-hover fs-6 fw-semibold">
                            View Project
