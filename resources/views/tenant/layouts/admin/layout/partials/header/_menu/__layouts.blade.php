            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=layouts/light-sidebar" class="menu-link ">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=layouts/dark-sidebar" class="menu-link ">
                            <span class="menu-bullet"><span
                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=layouts/light-header" class="menu-link ">
                            <span class="menu-bullet"><span
                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=layouts/dark-header" class="menu-link ">
                            <span class="menu-bullet"><span
                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=toolbars/classic" class="menu-link ">
                            <span class="menu-bullet"><span
                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=toolbars/saas" class="menu-link ">
                            <span class="menu-bullet"><span
                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=toolbars/accounting" class="menu-link ">
                            <span class="menu-bullet"><span
                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=toolbars/extended" class="menu-link ">
                            <span class="menu-bullet"><span
                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=toolbars/reports" class="menu-link ">
                            <span class="menu-bullet"><span
                                    class="bullet bullet-dot bg-gray-300i h-6px w-6px"></span></span>
