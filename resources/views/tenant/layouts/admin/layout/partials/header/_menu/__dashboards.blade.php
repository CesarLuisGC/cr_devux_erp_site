            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=index" class="menu-link active">
                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                <i class="ki-duotone ki-element-11 text-primary fs-1"><span class="path1"></span><span
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=dashboards/ecommerce" class="menu-link ">
                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=dashboards/projects" class="menu-link ">
                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=dashboards/online-courses" class="menu-link ">
                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=dashboards/marketing" class="menu-link ">
                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                <i class="ki-duotone ki-chart-simple text-dark fs-1"><span class="path1"></span><span
                                        class="path2"></span><span class="path3"></span><span
                                        class="path4"></span></i> </span>
                            <span class="d-flex flex-column">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=dashboards/bidding" class="menu-link ">
                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=dashboards/pos" class="menu-link ">
                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="menu-item p-0 m-0">
                        <!--begin:Menu link-->
                        <a href="?page=dashboards/call-center" class="menu-link ">
                            <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
