...
<body class="presentation-page">
            ...
            <div class="col-12">
                <nav
                    ...
                    <div class="container-fluid px-0">
                        <a class="navbar-brand font-weight-bolder ms-sm-3" href="{{ route('tenant.welcome') }}"
                        ...
                        <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
                            <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
                                ...
                                @if (Route::has('tenant.login'))
                                    @auth
                                        <li class="nav-item ms-lg-auto">
                                            <a class="nav-link nav-link-icon me-2" href="{{ route('tenant.dashboard') }}">
                                    ...
                                    @else
                                        <li class="nav-item my-auto ms-3 ms-lg-0">
                                            <a href="{{ route('tenant.login') }}"
                                                class="btn btn-sm bg-gradient-info btn-round mb-0 me-1 mt-2 mt-md-0">@lang('auth.login')</a>
                                        </li>
    ...
    @include('tenant.layouts.auth.javascript')
